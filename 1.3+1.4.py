...
while True:  # зацикливаем программу
    while True:  # зацикливаем проверку на ошибки
        try:
            ...
            if length > 30:
                ...
                inp = input('Want to input the array? Print "1". Want to use the example? Print anything else: ')
                if inp == '1':
                    for i in range(length):
    ...
    method = input('Choose which sort method you want to use.\n'  # выбор метода сортировки
                   'Bubble sort - input "1"\n'
                   ...
                   'Heap sort - input "6"\n'
                   '')
    up_down = input('Ascending list - input "1"\n'  # выбор по возрастанию или по убыванию
    ...
    def bubble_sort_ascending(my_list):
        ...
        for k in range(last_item):  # вложенным циклом перебираем все элементы массива
            for j in range(last_item - k):
                if my_list[j] > my_list[j + 1]:  # каждый элемент, что меньше следующего, меняем с ним местами в с.45
                    comparisons += 1
    ...
    elif method == '1' and up_down == '2':
        print('Descending new list: ', bubble_sort_descending(old_list).copy())
    elif method == '2' and up_down == '1':
        print('Ascending new list: ', selection_sort_ascending(old_list).copy())
    elif method == '2' and up_down == '2':
        print('Descending new list: ', selection_sort_descending(old_list).copy())
    elif method == '3' and up_down == '1':
        print('Ascending new list: ', insertion_sort_ascending(old_list).copy())
    elif method == '3' and up_down == '2':
        print('Descending new list: ', insertion_sort_descending(old_list).copy())
    elif method == '4' and up_down == '1':
        print('Ascending new list: ', cocktail_sort_ascending(old_list).copy())
    elif method == '4' and up_down == '2':
        print('Descending new list: ', cocktail_sort_descending(old_list).copy())
    elif method == '5' and up_down == '1':
        print('Ascending new list: ', shell_sort_ascending(old_list).copy())
    elif method == '5' and up_down == '2':
        print('Descending new list: ', shell_sort_descending(old_list).copy())
    elif method == '6' and up_down == '1':
        print('Ascending new list: ', heap_sort_ascending(old_list).copy())
    else:
        print('Descending new list: ', heap_sort_descending(old_list).copy())
    print('Program execution time is ', timeit.timeit(number=100000))

    repeat = input(
        'Input 1 if you want to continue. If you do not, input anything else: ')  # спрашиваем, или пользователь
